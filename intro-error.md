...
## AskiaPortal errors
In addition to all DesignOnline API specific errors (see below), you may also receive some platform specific errors. See them here: [AskiaPortal errors](http://installers.askia.com/HelpDesk/devs/AskiaPortalCmnDoc/html/T_AskiaPortalCmn_Exceptions_ExceptionCode.htm)
